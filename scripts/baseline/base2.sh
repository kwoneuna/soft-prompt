...
#     for DOMAIN in 'c' 
#     do
#       DIR=outputs_baseline/coop/conflict/${TRAINER}/${DATASET}/${CFG}/${BACKBONE//\//}/${DOMAIN}/seed_${SEED}/warmup_${WARMUP}
...
#     for DOMAIN in '2'
#     do
#       DIR=outputs_baseline/test/${TRAINER}/${DATASET}/${CFG}/${BACKBONE//\//}/${DOMAIN}/seed_${SEED}/warmup_${WARMUP}
