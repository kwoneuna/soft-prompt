...
# bash scripts/baseline/base2.sh ViT-B/16 CoOp 0
...
# bash scripts/baseline/base2.sh ViT-B/16 Dual 0
...
#     for DOMAIN in  's'
#     do
#       DIR=outputs_baseline/multi-dg/${TRAINER}/test3/${DATASET}/${CFG}/${BACKBONE//\//}/${DOMAIN}/seed_${SEED}/warmup_${WARMUP}
...
do
  ...
  do
    for DOMAIN in 'l'
    do
      DIR=outputs_baseline/multi-dg/${TRAINER}/channel2/07_oracle_weight_0.5/${DATASET}/${CFG}/${BACKBONE//\//}/${DOMAIN}/seed_${SEED}/warmup_${WARMUP}
...
#     for DOMAIN in 'a' 
#     do
#       DIR=outputs_baseline/multi-dg/${TRAINER}/test2/${DATASET}/${CFG}/${BACKBONE//\//}/${DOMAIN}/seed_${SEED}/warmup_${WARMUP}
...
#     for DOMAIN in '1' '2' 
#     do
#       DIR=outputs_baseline/multi-dg/${TRAINER}/sup_test/${DATASET}/${CFG}/${BACKBONE//\//}/${DOMAIN}/seed_${SEED}/warmup_${WARMUP}
